          ...
          >
            {data.map((item, key) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`flex w-full ${opened === key && 'text-blue-600'} cursor-pointer border-b  gap-5 justify-between `}
                onClick={() => {
                  if (opened === key) {
                    setOpened(100);
                  } else {
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-lg duration-300 lg:text-xl font-semibold">{item[0]}</p>
                  <div
